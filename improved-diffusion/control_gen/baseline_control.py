...
def main():
    ...
    if args.mode == 'tree':
        ...
        for label_class_dict in control_label_lst:  # control_label_lst[:100]:
            ...
            out_text = generate_samples(args, prompt_ids['input_ids'].to(dist_util.dev()), model, tokenizer)
        ...
        #
        # generate_gpt2(args, prompt_ids['input_ids'].to(dist_util.dev()))
    ...
    if args.mode == 'spans':
        ...
        for span_info in control_label_lst:  # control_label_lst[:100]:
            ...
            if args.finetune == 'yes':
                ...
                out_text = generate_samples_from_scratch(args, prompt_ids.to(dist_util.dev()), model, tokenizer, rev_tokenizer)
...
def eval(args):
    ...
    for x in text_samples:
        ...
        # print(tokenized_x)
        tokenized_x = torch.LongTensor(tokenized_x).to(dist_util.dev())
