...
def main():
    ...
    wandb.init(
        ...
        # resume=True if args.resume_checkpoint else False,
        # id='run-20220813_203738-30hxlrkr',
    )
    ...
    if args.modality == 'image':
        ...
        if args.modality == 'roc-aug' or args.modality == 'commonGen-aug':
            tokenizer = load_tokenizer(
                args.modality, args.experiment, 'predictability/diffusion_models_v7/diff_roc_pad_rand16_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd108_xstart')
...
def create_argparser():
    defaults = dict(
        ...
        log_interval=50,
        save_interval=50000,
        resume_checkpoint='',#diffusion_models/diff_roc-free_pad_rand128_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd101_xstart_e2e/model015000.pt',
        use_fp16=False,
        fp16_scale_growth=1e-3,
        seed=101,
        gradient_clipping=-1.0,
        eval_interval=2000,
        checkpoint_path='diffusion_models/diff_roc-free_pad_rand128_transformer_lr0.0001_0.0_2000_sqrt_Lsimple_h128_s2_d0.1_sd101_xstart_e2e'
    )
